...
public class GetFeatureTestConditionsIT {
	...
	@Test
	public void testCheckFeatureTypesDescribedInSchema_SingleFeatureType() throws Exception {
		boolean featureTypesDescribedInSchema = GetFeatureTestConditions
			.checkFeatureTypesDescribedInSchema(capabilitiesSingleFeatureType(), describeFeatureTypeResponse());

		assertThat(featureTypesDescribedInSchema, is(true));
	}

	@Test
	public void testCheckFeatureTypesDescribedInSchema_FeatureTypeFromImportedSchema() throws Exception {
		boolean featureTypesDescribedInSchema = GetFeatureTestConditions.checkFeatureTypesDescribedInSchema(
				capabilitiesFeatureTypeFromImportedSchema(), describeFeatureTypeResponse());

		assertThat(featureTypesDescribedInSchema, is(true));
	}

	@Test
	public void testCheckFeatureTypesDescribedInSchema_UndefinedFeatureType() throws Exception {
		boolean featureTypesDescribedInSchema = GetFeatureTestConditions.checkFeatureTypesDescribedInSchema(
				capabilitiesSingleFeatureTypeUndefined(), describeFeatureTypeResponse());

		assertThat(featureTypesDescribedInSchema, is(false));
	}

	@Test
	public void testCheckFeatureTypesDescribedInSchema_FeatureTypeWithWrongNamespace() throws Exception {
		boolean featureTypesDescribedInSchema = GetFeatureTestConditions.checkFeatureTypesDescribedInSchema(
				capabilitiesSingleFeatureTypeWrongNamespace(), describeFeatureTypeResponse());
	...
	private Node asNode(String resource) throws Exception {
		...
		InputStream is = GetFeatureTestConditionsIT.class.getResourceAsStream(resource);
		try {
