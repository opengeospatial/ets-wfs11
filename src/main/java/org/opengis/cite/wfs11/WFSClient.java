...
public class WFSClient {
	...
	public Document getFeatureByType(QName typeName) throws Exception {
	...
	public InputStream getFeatureType() throws MalformedURLException,
			IOException {
		// TODO Auto-generated method stub
		return new URL(
				"http://cite.lat-lon.de/deegree-webservices-3.3.6/services/wfs110?&service=WFS&version=1.1.0&request=DescribeFeatureType")
				.openStream();
	}
